...
namespace School_Mangement
{
    public partial class Student: Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-AJ4R5V4;Initial Catalog=schooldb;Integrated Security=True;Encrypt=False");
            con.Open();
            SqlCommand cnn = new SqlCommand("update studentab set studentname=@studentname,d0b=@dob,geneder=@gender,phone=@phone,email=@email where studentid=@studentid", con);
            cnn.Parameters.AddWithValue("@StudentId", int.Parse(textBox1.Text));
            cnn.Parameters.AddWithValue("@StudentName", textBox2.Text);
            cnn.Parameters.AddWithValue("@Dob", dateTimePicker1.Value);
            cnn.Parameters.AddWithValue("@Gender", textBox3.Text);
